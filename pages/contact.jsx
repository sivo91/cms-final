      ...
      <Box style={{backgroundColor: '#fcfcfc'}} w={'full'} py={10}>
        ...
        <Center>
          <Text mt={13} fontSize={20} className='breakpoint-text'>
            CMS Project respects your privacy and takes comprehensive measures to safeguard your personal and business information. We will not sell or lease your personal information to third parties unless we have your permission or are required by law to do so.
          </Text>
        </Center>
      </Box>
